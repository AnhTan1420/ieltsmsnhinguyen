...
import type { AdvancedStructure, BandProgression, Correction, EssayUpgrade, GradingFeedback, SubmissionRow, VocabularySuggestion } from "@/lib/types";
import {
...
function showBand(score: unknown): string {
