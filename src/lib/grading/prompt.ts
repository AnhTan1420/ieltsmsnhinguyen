...
- ⛔ YÊU CẦU BẮT BUỘC VỀ "original_sentence": Bạn PHẢI chọn ĐÚNG MỘT câu cụ thể có thật trong bài làm để áp dụng cấu trúc này.
- TUYỆT ĐỐI KHÔNG ĐƯỢC để trường "original_sentence" là chuỗi rỗng ("").
- Dữ liệu trong "original_sentence" PHẢI LÀ COPY-PASTE CHÍNH XÁC 100% từ bài học sinh (kể cả chứa khoảng trắng thừa, sai chính tả, sai dấu câu). Không được phép tự động sửa/lược bỏ bất kỳ ký tự nào của câu gốc.
