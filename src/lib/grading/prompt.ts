...
- Band 7: lỗi THỰC SỰ ít (không chỉ "ít hơn band 6 một chút") và không gây khó hiểu ở bất kỳ chỗ nào; dùng được ĐA DẠNG cấu trúc phức một cách tự nhiên trong phần lớn bài (không phải chỉ 1-2 câu phức lẻ tẻ giữa hàng loạt câu đơn); MỌI luận điểm chính đều được giải thích/ví dụ cụ thể, không đoạn nào chỉ khẳng định suông.
...
- ƯU TIÊN chọn cấu trúc áp dụng để nâng cấp lại ĐÚNG MỘT câu có thật, nguyên vẹn trong bài làm (không phải gộp ý từ 2+ câu khác nhau) — vì loại này luôn điền được "original_sentence" và mới highlight được cho học sinh xem đúng vị trí trong bài. CHỈ khi thực sự không tìm được câu đơn lẻ nào phù hợp (VD cấu trúc cần gộp ý từ nhiều câu rời rạc) mới chấp nhận để "original_sentence" rỗng — và trường hợp này nên là THIỂU SỐ (tối đa 1 trong số các gợi ý), không phải phần lớn.
- Với mỗi mục: nếu nâng cấp một câu CỤ THỂ đã có sẵn trong bài làm, điền "original_sentence" bằng nguyên văn CHÍNH XÁC TỪNG KÝ TỰ câu đó (copy-paste, không sửa/diễn giải — dùng để tô sáng đúng vị trí trong bài làm cho học sinh xem); nếu thực sự là gợi ý tổng hợp không gắn với câu cụ thể nào (trường hợp hiếm, xem trên), để "original_sentence" là chuỗi rỗng "".
